                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control " name="officeId" id="officeId">
                                        ...
                                        @forelse ($officeList as $tg)
                                            <option value="{{ $tg['officeId'] }}" {{ $filter_array['officeId']==$tg['officeId']?'selected':''}}>
                                                {{ $tg['officeName'] }}
                                            </option>
                                        @empty
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control " name="roleName" id="roleName">
                                        ...
                                        @forelse ($roles as $tg)
                                            <option value="{{ $tg }}" {{ $filter_array['roleName']==$tg?'selected':'' }}>
                                                {{ $tg }}
                                            </option>
                                        @empty
                                            <option value="">No record found </option>
            ...
            <div class="col-12">
                <div class="row text-center">
                    <div class="col-md-4 mx-auto">
                        <button id="filter" type="button" class="btn btn-success px-4 justify-content-between">

                            <span> {{ __('Filter') }}</span></button>

                    </div>
                    <div class="col-md-4 mx-auto">
                        <button id="reset" type="button" class="btn btn-outline-primary px-4 justify-content-between">
    ...
    <script>
        $(document).ready(function() {
            $('#reset').click(function() {
                $('#officeId').val('');
                $('#roleName').val('');
                var url = "{{ route('superadmin.user.filter_result') }}";
                    $.ajax({
                        url: url,
                        type: 'POST',
                        data: {
