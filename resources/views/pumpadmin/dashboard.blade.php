...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center p-3">
            {{-- @dd($pumpadmin_dashboard_data) --}}
            <div class="col-md-12 ">
                <div class="row mx-auto">
                    @include('pumpadmin._partial.section_header')
                </div>

                <div class="row pb-2">
                    @include('pumpadmin._partial.section_filter')
                </div>
                <section>
                    <div class="row">
                        <div class="col-md-8" id="section_graph1">
                            @include('pumpadmin._partial.section_graph1')
                        </div>
                        <div class="col-md-4" id="section_graph2">
                            @include('pumpadmin._partial.section_graph2')
                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#filter').click(function() {
                ...
                $.ajax({
                    url: "{{ route('pumpadmin.dashboard_filter') }}",
                    type: "POST",
                    data: {
                        officeId: office,
                        fromDate: startDate,
