            ...
            <div class="row">
                <div class="col-12">
                    <div class="box box-profile box-widget widget-user">
                        ...
                        data-url="{{ route('companyadmin.user.edit', $user->id) }}"
                        title="{{__('Edit')}}"
                        class="load-popup float-right btn btn-rounded btn-outline-light mt-1 edit-icon"> <i class="fa fa-edit"></i></a>
                          {{-- <h6 class="widget-user-desc">User Type : {{$user->usertype}}</h6> --}}
                          <h6 class="widget-user-desc">{{__('Office')}} : {{$user->officeName}}</h6>
