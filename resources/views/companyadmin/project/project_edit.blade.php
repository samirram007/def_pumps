                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="projectName"
                                                            name="projectName" value="{{ $editCollection->projectName }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control " name="officeId" id="officeId">
                                                            ...
                                                            @forelse ($officeList as $tg)
                                                                <option value="{{ $tg['officeId'] }}" {{ $editCollection->officeId==$tg['officeId'] ? 'selected' : '' }}>
                                                                    {{ $tg['officeName'] }}
                                                                </option>
                                                            @empty
                                                ...
                                                <div class="col-6 pr-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" required class="form-control"
                                                            ...
                                                            value="{{ date('Y-m-d',strtotime($editCollection->startDate)) }}"
                                                ...
                                                <div class="col-6 pl-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" required class="form-control"
                                                            ...
                                                            value="{{   date('Y-m-d',strtotime($editCollection->endDate)) }}"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea  class="form-control" id="projectDescription" name="projectDescription"
                                                            placeholder="Enter Project Description">{{  $editCollection->projectDescription  }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="row text-center">
                                                        <div class="col-6 mx-auto">
                                                            <input type="text" class="sr-only" value={{$editCollection->projectId}}>
                                                            <button type="submit"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#formCreate").on("submit", function(event) {
                ...
                const url = "{{ route('companyadmin.project.update') }}";
