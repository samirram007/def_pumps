        ...
        <div class="row justify-content-center p-3">
            <div class="col-md-12 ">
                ...
                <div class="row pb-2">
                    ...
                    <div class="col-md-2 d-flex justify-content-start align-items-center mt-4">
                            ...
                            <div class="card-body overflow-hidden d-flex">
                                ...
                                <div id="chartOneData" class="d-none">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-striped table-md w-100">
                                            <tr>
                                                <th>Date</th>
