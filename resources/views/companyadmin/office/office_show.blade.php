<div class="modal-dialog modal-lg  modal-dialog-centered mt-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="3" id="officeAddress" name="officeAddress" placeholder="{{__('Enter Address')}}">{{ $editData->officeAddress }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            // make all input and select readonly and disabled
            $('input, select, textarea').attr('readonly', true);
            $('input, select, textarea').attr('disabled', true);
            // $('input, select, textarea').css('background-color', '#ffffff');
            // $('input, select, textarea').css('border-color', '#ffffff');
            // $('input, select, textarea').css('border-bottom-color', '#22f2f6');
            // $('input, select, textarea').css('outline', '#ffffff');
            // $('#formCreate').submit();
