<div class="modal-dialog modal-lg  modal-dialog-centered mt-0">
    ...
    <style>
        ...
        .custom-new {line-height: 1;border-radius: 5px !important;}
        @-webkit-keyframes runleft {
            ...
            .btn-primary:disabled {background-color: #babfc5;border-color: #a5a5a5;}
            .btn-primary:disabled:hover { cursor:not-allowed;}
               /*********** For Dark Theme*************/
            .lights-off .addClass  {background: #05050c;}
            .lights-off .activeClass {    border: 2px solid #00a4ff;background: #05050c;}
