<div class="modal-dialog modal-lg  modal-dialog-centered mt-0 ">
    <div class="modal-content bg-info">
        <div class="modal-header">
            <h4 class="modal-title text-light" id="title">{{ __('Edit Driver') }} </h4>
    ...
    <script>
        ...
        function save_driver() {
            ...
            var officeId = "{{ $editData['officeId'] }}";
            var driverId = "{{ $editData['driverId'] }}";
            if (driverName == '') {
           ...
           if (contactNumber == '') {
            ...
            var url = "{{ route('companyadmin.driver.update') }}";
