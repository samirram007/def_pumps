                                ...
                                <div class="card-body">
                                        ...
                                        @if (isset($masterOfficeList))
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="masterOfficeId" id="masterOfficeId"
                                                        class="form-control">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-12  d-flex justify-content-end">
                                            ...
                                            <button type="button"
                                            onclick="loadGodown('1ACA5113-B507-465C-AC0D-08DBA0A3D017')"
        ...
        $("#formCreate").on("submit", function(event) {
            ...
            $.ajax({
                ...
                if (!data.status) {
                    ...
                    $('.submit').html("{{ __('Save and Next') }}");
                } else {
                    toastr.success(data.message);
                    //console.log();
                      loadGodown(data.officeId);
                    // location.reload();
                }
            }).fail(function(data) {
