...
.accordion-item {background-color: #e2e0e0; width:100%;}
.accordion-button {position: relative;display: flex;align-items: center;width: 100%;padding: 0.1rem 1.25rem;font-size: 1rem;color: #212529;text-align: left;background-color: #fff;
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="column">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table class="table table-responsive custom-table-shadow">
                            <thead>
                                <tr>
                                        ...
                                        <tr class="v-midlle accordion-item">
                                            ...
                                            <td class="text-left  " style=" text-align:left!important;">
                                                <div class="d-inline-flex">
                                                    <a href="javascript:" data-param="" data-url="http://115.124.120.251:5007/companyadmin/office/show/9228188f-9085-404c-6669-08db0905751f" title="View" class="load-popup   mx-2 text-info ">
                                                        <i class="fa fa-eye fa-lg "></i>
                                                    </a>
                                                    <a href="javascript:" data-param="" data-url="http://115.124.120.251:5007/companyadmin/office/edit/9228188f-9085-404c-6669-08db0905751f" title="Edit" class="load-popup   mx-2 text-info d-inline-flex">
                                                        <i class="fa fa-edit fa-lg "></i>
                                                    </a>
                                                    <a href="http://115.124.120.251:5007/companyadmin/office/users/9228188f-9085-404c-6669-08db0905751f" data-param="" data-url="http://115.124.120.251:5007/companyadmin/office/users/9228188f-9085-404c-6669-08db0905751f" title="Users" class="mx-2 text-info d-inline-flex">
