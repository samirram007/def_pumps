<div class="modal fade" id="modal-delete" role="tooltip" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="min-height: 30vh">
            ...
            <div class=" modal-body bg-transparent py-2 px-2">
                ...
                <div id="listPayload" class="w-100 mt-2 px-4 text-secondary">
                    ...
                    {{ __('desc.delete_message_delivery_plan') }}
            ...
            <div class="modal-footer bg-transparent py-1 px-1">
                <div class="row w-100 mx-0">
                    ...
                    <div class="col-12 d-flex justify-content-end  " style="gap:20px;">
                        <button type="button"
                            class="remove_delivery_plan btn btn-info animated-shine btn-sm">{{ __('Confirm') }}</button>
    ...
    <form id="formDelete">
        @csrf
        <input class="sr-only " type="text" name="deliveryPlanId" id="deliveryPlanId">
    </form>
</div>
<script>
    function deleteModal(el, deliveryPlanId) {
        ...
        $('#formDelete #deliveryPlanId').val(deliveryPlanId)
...
<script>
    $('.remove_delivery_plan').on('click', (el) => {
        // console.log(el.target.innerHTML);
        //var deliveryPlanId = $('#panelDeliveryPlanDelete #deliveryPlanId').val();
        ...
        let url = `{{ route('companyadmin.delivery_plan.delete') }}`;
        var formData = new FormData($('#formDelete')[0])

        // formData.append('deliveryPlanId', officeId);
