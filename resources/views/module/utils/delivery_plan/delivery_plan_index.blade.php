                        ...
                        "render": function(data, type, full, meta) {
                            ...
                            if (data.driver == null) {
                                return `<div class="  text-left   text-info text-weight-bold">
                                        <a href="javascript:"  data-param="${this_id}" data-url="${this_driver_url}"  title="{{ __('Assign Driver') }}" class="     text-info p-2 ">Assign Driver</a>
                                    </div>`;
                            } else {
                                return `<div class="   text-left   text-info text-weight-bold">
                                        <a href="javascript:"  data-param="${this_id}" data-url="${this_driver_url}"  title="{{ __('Driver') }}" class="     text-info p-2 ">
