                ...
                <div class="wizard-box scroll-box card card-primary   mr-md-2">
                    ...
                    <div class="card-body d-flex flex-column justify-content-start">
                        ...
                        <div class="row ">
                            ...
                            <div id="h-officeName" class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="officeName" name="officeName"
                                        value="{{ old('officeName') }}" maxlength="20"
                                        placeholder="{{ __('Pump Name') }}" onkeyup="countchar(this,'officeName',20);">
                            ...
                            <div id="h-officeAddress" class="col-md-6 sr-only">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-4 px-4 fixed-box ">
                                {{-- <button type="submit" id="h-officeSave"
                                    ...
                                    {{ __('Save & Next') }}</button> --}}
                                <a href="javascript:" onclick="handleClickStoreOffice(this)"
                                    class="btn-office-store  btn   btn-rounded animated-shine  w-100 px-4">
                                    {{ __('Save & Next') }}</a>
