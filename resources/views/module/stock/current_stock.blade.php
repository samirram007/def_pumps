                    ...
                    <section class="content">
                        <div class="rounded card p-3 bg-white shadow min-h-100">
                            <div class="row mx-auto">
                                ...
                                <h3 class="card-title  "> {{__('Current Stock for')}} {{ $office['officeName'] }} as on
                                    {{ date('d-m-Y') }}</h3>
                                            ...
                                            @forelse ($current_stock as $item)
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="text" class="sr-only" name="stock[]" value="{{$item['currentStock']}}">
                                                    ...
                                                    <td style="border-bottom:2px dashed #000!important;">
                                                        ...
                                                        onInput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                                         name="currentStock[]" value="{{ number_format($item['currentStock'],2,'.','') }}">
                                                    </td>
                                                </tr>
