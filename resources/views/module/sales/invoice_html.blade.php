    ...
    <div class="site-index">
        <div class="body-content">
            <div class="pull-right">
                <button class="btn btn-primary btn-xs" id="changeLanguage"
                    data-lang='{{ str_replace('_', '-', app()->getLocale()) }}'>{{ str_replace('_', '-', app()->getLocale()) }}</button>
            ...
            <div class="container-fluid" id="site-index" style="background-color:#fff;">
                <div class="page-header text-center" style="border-bottom: dashed 1px;">
                    ...
                    <div style="display: flex; justify-content:center; flex-wrap:wrap;">
                        @if ($sales_invoice['officeContactNo']!='')
                            <div> {{ __('Contact No') }}: {{ $sales_invoice['officeContactNo'] }}</div>
                        @endif

                        @if ($sales_invoice['officeEmail']!='')
                            <div>, {{ __('Email') }}:
                            {{ strtolower($sales_invoice['officeEmail']) }}</div>
                        @endif
            ...
            <div class="row">
                <div class="col-md-10 col-xs-10">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-126">{{ __('Bill No.') }} : {{ $sales_invoice['invoice_no'] }}
                        </div>
                    </div>
                    ...
                    @if ($sales_invoice['customerName'] != '')
                        <div class="row">
                            <div class="col-md-12 col-xs-12">{{ __('Name') }} :
                                {{ $sales_invoice['customerName'] }}
                            </div>
                        </div>
                    @endif
                    @if ($sales_invoice['contactNo'] != '')
                        <div class="row">
                            <div class="col-md-12 col-xs-12">{{ __('Mobile') }} : {{ $sales_invoice['contactNo'] }}
                            </div>
                        </div>
                    @endif
                    @if ($sales_invoice['vehicleNo'] != '')
                        <div class="row">
                            <div class="col-md-12 col-xs-12">{{ __('Vehicle No') }} :
                                {{ $sales_invoice['vehicleNo'] }}
                            </div>
                        </div>
                    @endif
                </div>
                        ...
                        <tbody>
                            ...
                            <tr style="border-top: dashed 1px;">
                                ...
                                <td colspan="2" style="border-top: none;" align="right">
                                    {{ number_format($sales_invoice['invoice_sub_total'], 2, '.', '') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            @if ($sales_invoice['discount'] > 0)
                ...
                <div class="row" style="font-weight:bold;font-size:14px;">
                    ...
                    <div class="col-md-4 col-xs-6 text-right">{{ number_format($sales_invoice['invoice_sub_total'], 2, '.', '') }}</div>
                </div>
                <div class="row" style="font-weight:bold;font-size:14px;">
            ...
            <div class="row" style="font-weight:bold;font-size:14px;  ">
                ...
                <div class="col-md-4 col-xs-6 text-right">
                    {{ number_format($sales_invoice['productTotalPrice'], 2, '.', '') }}</div>
            </div>
