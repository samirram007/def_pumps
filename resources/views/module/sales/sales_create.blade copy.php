<div class="modal-dialog modal-lg  modal-dialog-centered mt-0 ">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3  ">
                                                    <div class="form-group">
                                                        <label for="godownId">{{ __('Tanks') }} <span
                                                                class="text-danger">*</span> </label>
                                                        ...
                                                        <select class="form-control " name="godownId" id="godownId">
                                                            ...
                                                            {{-- @forelse ($godownList as $tg)
                                                                <option value="{{ $tg['godownId'] }}"
                                                                    data-isstorage="{{ $tg['isStorage'] == 1 ? '1' : '0' }}">
                                                                    {{ __($tg['godownName']) }}
                                                                </option>
                                                            @empty
                                                                <option value="">{{ __('No record found') }}
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //         'data-iscontainer');
            //     // return
            //     // GetGodownsWithStockByOfficeId
            //     var url = "{{ route($routeRole . '.godownlist', ':id') }}";
            //     // var url = "{{ route($routeRole . '.GodownsWithStock', ':id') }}";
            //     url = url.replace(':id', officeId);
            //     $.ajax({
            //             type: "GET",
            //             url: url,
