...
class ApiController extends Controller
{
    ...
    {
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'FiscalYear')->json();
        //dd($res);
        return $res;
    }
    public static function GetFiscalYearById($id)
    {
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'FiscalYear/' . $id)->json();
        return $res;
    }
    ...
    // Godowns
    public static function GetGodownsByOfficeId($officeId)
    {
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'Godown/GetGodownList/' . $officeId)->json();
        return $res;
    }
    public static function GetGodownsWithStockByOfficeId($officeId)
    {
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'Godown/GetCurrentStockWithGodownByOfficeId/' . $officeId)->json();
        return $res;
    }
    public static function GetGodownsWithStockByGodown($godownId)
    {
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'Godown/GetGodownWithStock/' . $godownId)->json();
        //dd($godownId);
        return $res;
    }
    public static function createGodown($data)
    {
        // dd(json_encode($data));
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->post(env('API_RESOURCE_URL') . 'Godown/Store', $data);
        return $res;
    }
    public static function updateGodown($data)
    {
        //dd(json_encode($data));
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->post(env('API_RESOURCE_URL') . 'Godown/Update', $data);
        return $res;
    }
    public static function deleteGodown($godownId)
    {
        //dd(json_encode($data));
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->delete(env('API_RESOURCE_URL') . 'Godown/Delete/' . $godownId);
        return $res;
    }
    public static function getGodown($godownId)
    {
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'Godown/GetGodown/' . $godownId)->json();
        //dd($res);
        return $res;
    }
    public static function GetBusinessTaxTypes()
    {
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'Sales/BusinessTaxTypes')->json();
        //dd($res);
        return $res;
    }
    //======== for admin ===========
...
//==================== Sales ==============================
    ...
    public static function GetUnits()
    {
        //dd($data);
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'ProductType/GetUnits')->json();
        return $res;
    }
    public static function GetUnit($id)
    {
        //dd($data);
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'ProductType/GetUnit/' . $id)->json();
        return $res;
    }
    ...
    public static function saveProductType($data)
    {
        //dd($data);
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->post(env('API_RESOURCE_URL') . 'ProductType', $data);
        return $res;
    }
...
//dd(json_encode($data));
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->post(env('API_RESOURCE_URL') . 'ProductType/Update', $data);
        return $res;
    }
    ...
    public static function GodownTypes()
    {
        // dd($id);
        // dd(json_encode($data));
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'Godown/GodownTypes')->json();
        //dd($res);
        return $res;
    }
    public static function GodownType($godownTypeId)
    {
        // dd($id);
        // dd(json_encode($data));
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'Godown/GetGodownType/' . $godownTypeId)->json();
        //dd($res);
        return $res;
    }
    public static function updateGodownStock($data)
    {
        // dd($id);
        // dd(json_encode($data));
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->post(env('API_RESOURCE_URL') . 'Stock/SaveCurrentStock', $data);
        //dd($res);
        return $res;
    }
    ...
    public static function GetProductTypeByOrgId($orgId, $id)
    {
        //dd($data);
        $headers = ["Authorization" => "Bearer " . Session::get('_token'), "Accept" => "*"];
        $res = Http::withHeaders($headers)->get(env('API_RESOURCE_URL') . 'ProductType/' . $orgId . '/' . $id)->json();
        return $res;
    }
